...
function HowToUse() {
    return (
            ...
            <div class="flex flex-col items-center gap-3">
                <h1 class="text-slate-900 font-bold text-2xl ">How to Use</h1>
                <h1 class="text-slate-900 font-bold ">WORKS AND PROJECTS</h1>
                <p class="w-1/2 text-center text-gray-600">Not an expericend one but few projects with quality and contextual basis.These are some projects developed by me.
                </p>
            </div>
                ...
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    <div class="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Scan the QR Code</h2>
                                <p class="leading-relaxed">Scan the QR code printed on your seed pack and Know your Seed Details.</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Visit to Website</h2>
                                <p class="leading-relaxed">Here you will get the major details of Seeds including Varieties, Yield information, </p>
                            </div>
                        </div>
                    </div>
                    <div class="flex relative pb-20 sm:items-center md:w-2/3 mx-auto">
                        ...
                        <div class="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                            ...
                            <div class="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                <h2 class="font-medium title-font text-gray-900 mb-1 text-xl">Set Reminder for Crops</h2>
                                <p class="leading-relaxed">Set a Reminder for the seed </p>
                            </div>
                        </div>
                    </div>
