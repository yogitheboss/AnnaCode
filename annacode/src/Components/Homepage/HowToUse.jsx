...
function HowToUse() {
    return (
            ...
            <div class="container px-5 py-12 mx-auto flex flex-wrap">
                ...
                <img alt="feature" class="object-cover object-center h-fit w-full" src="https://upload.wikimedia.org/wikipedia/commons/4/41/India_Farming.jpg"/>
                </div>
                ...
                <div class="flex flex-col mb-10 lg:items-start items-center">
                    ...
                    <div class="flex-grow">
                    <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Record Keeping</h2>
                    <p class="leading-relaxed text-base">With अन्न CODE your spray, employee, harvest, irrigation, and other production practice records are only a few clicks or taps away - whenever and wherever you need them.</p>
                ...
                <div class="flex flex-col mb-10 lg:items-start items-center">
                    ...
                    <p class="leading-relaxed text-base">Keep your farm on track and avoid forgotten or duplicated tasks.  Create your own schedules quickly and easily or choose from thousands of schedule templates.</p>
                    <a class="mt-3 text-green-500 inline-flex items-center">Learn More
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
                ...
                <div class="flex flex-col mb-10 lg:items-start items-center">
                    ...
                    <div class="flex-grow">
                    <h2 class="text-gray-900 text-lg title-font font-medium mb-3">Analytics & Reports</h2>
                    <p class="leading-relaxed text-base">अन्न CODE makes tracking your farm's progress a snap and can shave days off the auditing process.  Let us handle the paperwork so you can get back to your farm.</p>
                    <a class="mt-3 text-green-500 inline-flex items-center">Learn More
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                        </svg>
