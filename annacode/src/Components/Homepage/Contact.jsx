  ...
  return (
    <section className="text-gray-600 body-font relative">
       <div className="flex flex-col items-center p-0 gap-3">
                <h1 className="text-slate-900 font-bold text-2xl">CONTACT US</h1>
                <h1 className="text-slate-900 font-bold ">To Contact check out the Geolocation facility in web.</h1>
                <p className="w-1/2 text-center text-gray-500">Contact US on the given address 
                </p>
          </div>
